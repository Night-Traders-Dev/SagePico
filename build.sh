...
target_link_libraries(hello pico_stdlib hardware_adc hardware_pwm hardware_i2c hardware_spi hardware_pio hardware_dma hardware_interp hardware_sha256)
target_include_directories(hello PRIVATE "${SCRIPT_DIR}/src/pico/c")
target_include_directories(hello PRIVATE "${SCRIPT_DIR}/src/pico/c/core")
target_include_directories(hello PRIVATE "${SCRIPT_DIR}/src/pico/c/storage")
target_include_directories(hello PRIVATE "${SCRIPT_DIR}/src/pico/c/pio")
target_include_directories(hello PRIVATE "${SCRIPT_DIR}/src/pico/c/dma")
target_include_directories(hello PRIVATE "${SCRIPT_DIR}/src/pico/c/crypto")
target_include_directories(hello PRIVATE "${SCRIPT_DIR}/src/pico/c/vm")
target_include_directories(hello PRIVATE "${SCRIPT_DIR}/src/pico/c/system")
