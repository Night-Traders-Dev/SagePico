...
with open(os.path.join(base, 'src', 'pico', 'c', 'core', 'sage_bridge.h')) as f: bridge_code = f.read()
with open(os.path.join(base, 'src', 'pico', 'c', 'storage', 'flash_store.h')) as f: flash_code = f.read()
with open(os.path.join(base, 'src', 'pico', 'c', 'vm', 'rvvm.h')) as f: rvvm_code = f.read()
with open(os.path.join(base, 'src', 'pico', 'c', 'vm', 'gfx_vm.h')) as f: gfxvm_code = f.read()
data = data.replace(
